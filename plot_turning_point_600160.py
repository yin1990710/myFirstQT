...
def plot_chart(data):
    ...
    ax1.set_title('600160.SH 巨化股份 MA5走势与转折点标记', fontsize=16, fontweight='bold')
    ...
    output_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), '600160.SH.png')
...
def main():
    print("=" * 80)
    print("600160.SH 巨化股份 MA5走势与转折点标记")
    print("=" * 80)
