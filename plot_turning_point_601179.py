...
def plot_chart(data):
    ...
    ax1.set_title('601179.SH 中国西电 MA5走势与转折点标记', fontsize=16, fontweight='bold')
    ...
    output_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), '601179.png')
...
def main():
    print("=" * 80)
    print("601179.SH 中国西电 MA5走势与转折点标记")
    print("=" * 80)
