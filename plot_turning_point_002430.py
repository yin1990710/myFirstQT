...
def plot_chart(data):
    ...
    ax1.set_title('002430.SZ MA5走势与转折点标记', fontsize=16, fontweight='bold')
    ...
    output_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), '002430.SZ.png')
