...
def plot_chart(data):
    ...
    ax1.set_title('001337.SZ 四川黄金 MA5走势与转折点标记', fontsize=16, fontweight='bold')
    ...
    output_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), '001337.SZ.png')
...
def main():
    print("=" * 80)
    print("001337.SZ 四川黄金 MA5走势与转折点标记")
    print("=" * 80)
